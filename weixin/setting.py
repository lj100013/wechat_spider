urls = ["每日医学资讯", "医师报", "生物谷", "看医界",
            ...
            "哈特瑞姆心脏之声","医学之声", "医学界急诊与重症频道", "医学界神经病学频道",
            "神经时间","神经病学俱乐部", "医脉通神经科", "国际眼科时讯", "医信眼科", "视远惟明▪惟视眼科", "泌尿科那点事儿",
            "医学界外科频道", "中国实用外科杂志", "医学界儿科频道", "国际儿科学杂志", "医学界精神病学频道", "儿科学大查房",
            "人卫儿科", "中国儿科前沿论坛", "皮肤时间", "实用皮肤病学杂志", "医脉通肾内频道", "透析圈", "感染时间", "SIFIC感染官微", "医脉通抗感染",
            "医学界感染频道", "中华医学网","海上柳叶刀", "医学内刊", "内分泌时间", "神经科技", "医学界风湿免疫频道", "医学界临床药学频道", "老虎讲骨",
            "放疗时空", "医学界检验频道", "医学界影像诊断与介入频道", "放射沙龙", "肿瘤时间", "医学界肿瘤频道", "感染科空间", "SIFIC感染科普笔记",
            "下夜班", "医闻速递", "三甲传真", "创新医学网", "国际肝胆胰疾病杂志", "胃肠肿瘤外科", "中华儿科杂志", "儿科空间", "中国实用儿科杂志",
            "皮肤科钟华", "CSDCMA皮科时讯论坛", "医生汇心血管论坛", "急诊医学资讯", "中国急救医学杂志", "急诊时间", "中国小儿急救医学",
            "精神时间", "精神康复", "医脉通精神科", "大话精神", "神经科的那些事", "神经医学社区", "神经脊柱时讯", "医学界呼吸频道", "中国眼科医生",
...
#phantomJS_path = 'E:\\python\\phantomjs-2.1.1-windows\\phantomjs-2.1.1-windows\\bin\\phantomjs.exe'
