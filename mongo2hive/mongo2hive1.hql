...
trim(regexp_replace(value,'\\n|\\r','')) as value,
trim(regexp_replace(direction,'\\n|\\r','')) as direction,
trim(regexp_replace(currentBalance,'\\n|\\r','')) as currentBalance,
trim(regexp_replace(businesscode,'\\n|\\r','')) as businesscode,
trim(regexp_replace(businessid,'\\n|\\r','')) as businessid,
trim(regexp_replace(transid,'\\n|\\r','')) as transid,
...
trim(regexp_replace(id,'\\n|\\r','')) as id,
trim(regexp_replace(userId,'\\n|\\r','')) as userId,
trim(regexp_replace(serial,'\\n|\\r','')) as serial,
trim(regexp_replace(dsType,'\\n|\\r','')) as dsType,
trim(regexp_replace(drugCompanyId,'\\n|\\r','')) as drugCompanyId,
...
trim(regexp_replace(sex,'\\n|\\r','')) as sex,
trim(regexp_replace(loginTime,'\\n|\\r','')) as loginTime,
trim(regexp_replace(loginType,'\\n|\\r','')) as loginType,
trim(regexp_replace(appVersion,'\\n|\\r','')) as appVersion,
trim(regexp_replace(realTel,'\\n|\\r','')) as realTel
