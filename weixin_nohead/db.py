...
def process_item(item):
    ...
    try:
        cue.execute(
            "insert into wp_posts_nohead (post_author,post_date,post_date_gmt,post_content,post_title,post_status,post_name,guid,author,dept,source) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
